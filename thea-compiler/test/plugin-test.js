...
import { thea, text, dom } from '../src/constants';
...
a = [Mary.Elisabeth, Object.assign({ x: 12, children: [[${thea}.${text}, 'Test me! '], [${thea}.${dom}('file'), {}]]
}, y), '2'];`;
